...
with open('scaler_save.pkl','wb') as f:
...
EPOCHS = 70
best_acc = 0
save_path = 'lstm_best_emgonly.pth'
backup_save_path = 'lstm_best_emgonly_backup.pth'
for epoch in range(1, EPOCHS + 1):
    ...
    if val_acc > best_acc:
        ...
        print(f"Model saved at epoch {epoch} with f1 {best_acc:.4f}")
    torch.save({
            'epoch': epoch,
            'model_state_dict': model.state_dict(),
            'optimizer_state_dict': optimizer.state_dict(),
